  ...
  render() {
    return (
      <section className="login-section">
            ...
            >
              <div className="login-input">
                ...
                <div className="btn-login pt-4 pb-1">
                  ...
                  <a href="#" className="fopa-login text-dark pr-5">
                    <h6>فراموش کردن رمز عبور</h6>
                  </a>
                </div>
              </div>
            </form>
        ...
        <div className="col-xl-4 col-lg-4 d-none d-lg-block d-xl-none d-none d-xl-block back-login1"></div>
      </section>
    )
  }
}
